 ...
 */
@Stateless
public class ProductoCompraPersistence {
     ...
     */
    public ProductoCompraEntity create(ProductoCompraEntity entity) {
     ...
     */
    public ProductoCompraEntity update(ProductoCompraEntity entity) {
    ...
    public void delete(Long id) {
        ...
        ProductoCompraEntity entity = em.find(ProductoCompraEntity.class, id);
     ...
     * @return un producto.
     */
    public ProductoCompraEntity find(Long id) {
        
       
        return em.find(ProductoCompraEntity.class, id);
    }
     ...
     */
    public List<ProductoCompraEntity> findAll() {
       
        // Se crea un query para buscar todas las producto en la base de datos.
        TypedQuery query = em.createQuery("select u from ProductoCompraEntity u", ProductoCompraEntity.class);
     ...
     */
    public String getRestaurante(Long id){
        ProductoCompraEntity prod = em.find(ProductoCompraEntity.class, id);
